document.addEventListener('DOMContentLoaded', () => {
    ...
    function resetModalUI() {
        ...
        fileInput.value = ''; // Clear any selected files in the input
    ...
    function handleFiles(files) {
        ...
        if (currentTool.tool_id !== 'merge-pdf' && currentTool.tool_id !== 'jpg-to-pdf' && currentTool.tool_id !== 'organize-pdf') {
             uploadedFiles = [];
             previewArea.innerHTML = '';
        }
        ...
        if (currentTool.tool_id === 'merge-pdf' || currentTool.tool_id === 'jpg-to-pdf' || currentTool.tool_id === 'organize-pdf') {
             ...
             fileUploadArea.querySelector('p').textContent = 'Add more files or Drag & Drop here';
        }
    ...
    async function simulateProcessing() {
        ...
        // In a real application, you'd integrate a library like PDF-LIB for client-side PDF manipulation
        // or send files to a backend for complex operations.
        // For image conversions, HTML Canvas API or JS libraries could be used.
        // Example for PDF-LIB (conceptual, not implemented here):
        /*
        if (currentTool.tool_id === 'merge-pdf' && uploadedFiles.every(f => f.type === 'application/pdf')) {
            const { PDFDocument } = PDFLib; // Assuming PDF-LIB is loaded
            ...
            processedBlob = new Blob([mergedPdfBytes], { type: 'application/pdf' });
        }
        */
    }
    ...
    // Process Button
    processButton.addEventListener('click', simulateProcessing);
